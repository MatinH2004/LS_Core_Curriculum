...
def operation_to_message(op)
  operation = case op
              when '1' then prompt(messages('add_nums', @language))
              when '2' then prompt(messages('subtract_nums', @language))
              when '3' then prompt(messages('multiply_nums', @language))
              when '4' then prompt(messages('divide_nums', @language))
              end
  operation
end
