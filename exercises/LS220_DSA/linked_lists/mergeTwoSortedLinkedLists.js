...
ALGO:
  - init dummy to new list node
    - point next to whichever head is lesser
  - while either head is not null
    - init node
    - compare which input node is higher
    - assign node to lesser input node
    - assign input node to next node in list
