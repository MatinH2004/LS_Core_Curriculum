...
class Employee
  ...
  protected
  # needs to be protected instead of private, since we need it to compare in #== method
...
# The reason the code doesn't work is because private methods do not allow access between class instances. 
# Protected methods do allow access between class instances.