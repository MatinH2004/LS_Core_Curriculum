class TaskManager
  ...
  def display_high_priority_tasks
    # Below, the local variable `tasks` is called instead of the getter method
    # that is why an exception is raised.

    # tasks = tasks.select do |task|
    #   task.priority == :high
    # end

    # So we must give our variable a new name to disambiguate it from our getter method
